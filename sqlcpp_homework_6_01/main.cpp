...
void insertData(Wt::Dbo::Session& session);
...
void insertData(Wt::Dbo::Session& session)
{
	std::unique_ptr<Publisher> Litres{ std::make_unique<Publisher>() };
	Litres->name = "Litres";
	Wt::Dbo::ptr<Publisher> Litres_ptr = session.add(std::move(Litres));
	std::unique_ptr<Publisher> Labirint{ std::make_unique<Publisher>() };
	Labirint->name = "Labirint";
	Wt::Dbo::ptr<Publisher> Labirint_ptr = session.add(std::move(Labirint));
	std::unique_ptr<Publisher> Eksmo{ std::make_unique<Publisher>() };
	Eksmo->name = "Eksmo";
	Wt::Dbo::ptr<Publisher> Eksmo_ptr = session.add(std::move(Eksmo));


	std::unique_ptr <Book> warAndPeace_1{ std::make_unique<Book>() };
	...
	std::unique_ptr <Book> warAndPeace_2{ std::make_unique<Book>() };
	...
	std::unique_ptr <Book> warAndPeace_3{ std::make_unique<Book>() };
	...
	std::unique_ptr <Book> masterAndMargarita_1{ std::make_unique<Book>() };
	...
	std::unique_ptr <Book> masterAndMargarita_2{ std::make_unique<Book>() };
	...
	std::unique_ptr <Book> mertvieDushi_1{ std::make_unique<Book>() };
	...
	std::unique_ptr <Book> mertvieDushi_2{ std::make_unique<Book>() };
	...
	std::unique_ptr<Stock> stockMoscow_2{ std::make_unique<Stock>() };
	...
	std::unique_ptr<Stock> stockMoscow_3{ std::make_unique<Stock>() };
	...
	std::unique_ptr<Stock> stockMoscow_4{ std::make_unique<Stock>() };
	...
	std::unique_ptr<Sale> sale_4{ std::make_unique<Sale>() };
	sale_4->price = 115;
